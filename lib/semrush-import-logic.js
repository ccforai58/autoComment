(function initSemrushImportLogic(root) {
  ...
  function findSemrushColumns(header) {
    return {
      ...
      pageAscore: findHeaderIndex(header, [
        'Page ascore',
        'Page AS',
  ...
  function buildSemrushImportRows(input) {
    ...
    diagnostics.push({
      stage: 'columns',
      code: 'semrush_columns_detected',
      sourceUrlIndex: columns.sourceUrl,
      targetUrlIndex: columns.targetUrl,
      pageAscoreIndex: columns.pageAscore,
      minPageAscore: options.minPageAscore,
