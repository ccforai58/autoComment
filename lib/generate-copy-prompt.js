...
function buildUserPrompt(input = {}) {
  ...
  const manualInstruction = manualMode ? [
    ...
    'When commentText contains an HTML href with the required line break, represent that line break as the JSON escape sequence \\n. The receiving program restores it to a real line break after parsing.',
